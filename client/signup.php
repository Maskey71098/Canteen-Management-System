            ...
            <div class="media-container-column col-lg-8" >
                ...
                <form action="signup.php" method="POST" class="mbr-form form-with-styler"><input type="hidden" name="email" data-form-email="true" value="wTIbKpnzp9f3vhd7ZrWrUA3ln1Omrh001vRPBVkE6/JCSeF/iZLwKJjDzIdBLvpv18V9jWXH8svX3oUPBIv4Ft9W1gWmHEZm/fSmuP7trYtV2dpkAMhZr29kFQvROnbm">
                    ...
                    <div class="dragArea row row-sm-offset">
                        ...
                        <!--https://www.jotform.com/answers/649889-Using-PHP-and-SQL-to-populate-DropDown-options
                        -->
                        <div class="form-group col-md-4">
                             <label for="inputState">Select Your Canteen</label>
                              <select id="inputState" class="form-control" name="selecter">
                              <?php
                              $dropdown=$mysqliclientdb->query("SELECT * from canteen");
                              $menu='';
                             while($row = $dropdown->fetch_assoc()){
                                echo "<option value=".$row['dbase'].">".str_replace('_',' ',$row['cname']).", ".$row['location']."</option>";
                             }
                        ...
                        <div class="form-group col-md-4">
                             <label>Faculty Or Student</label>
                              <select id="canteen_selector" class="form-control" name="canteen_selecter">
