...
<head>
  ...
  <link rel="stylesheet" href="assets/errorstyle.css">
    ...
    <div class="container holder">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                ...
                <div class="mbr-section-btn text-center"><a class="btn btn-md btn-secondary display-4" href="login.php">SIGN IN</a>
                    <a class="btn btn-md btn-dark display-4" href="chooser.php">REGISTER</a></div>
