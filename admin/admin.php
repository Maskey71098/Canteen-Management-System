...
<section class="engine"></section><section class="mbr-section form1 cid-rpZeDDmCA8" id="form1-4">
        ...
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">
                    Join to digitize your canteen today.</h3>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" >
                <!---Formbuilder Form--->
                <form action="admin.php" method="POST" class="mbr-form form-with-styler"><input type="hidden" name="email" data-form-email="true" value="wTIbKpnzp9f3vhd7ZrWrUA3ln1Omrh001vRPBVkE6/JCSeF/iZLwKJjDzIdBLvpv18V9jWXH8svX3oUPBIv4Ft9W1gWmHEZm/fSmuP7trYtV2dpkAMhZr29kFQvROnbm">
                    <div class="text-center">
                      <?php
                      if(isset($_SESSION['fn_error']) && $_SESSION['fn_error']==true){?>
                        
                        <p style="color:red;">Please enter a valid first name (Only characters allowed)</p>
  
                     <?php }
                     if(isset($_SESSION['ln_error']) && $_SESSION['ln_error']==true){?>
                        
                        <p style="color:red;">Please enter a valid last name (Only characters allowed)</p>
  
                     <?php }
                     if(isset($_SESSION['cn_error']) && $_SESSION['cn_error']==true){?>
                        
                        <p style="color:red;">Please enter a valid canteen name (Only characters and spaces allowed)</p>
                    ...
                    <div class="dragArea row row-sm-offset">
                        <div class="col-md-4  form-group" data-for="name">
                            <label for="name-form1-4" class="form-control-label mbr-fonts-style display-7">First Name (Admin)</label>
                        ...
                        <div class="col-md-4  form-group" data-for="name">
                            <label for="name-form1-4" class="form-control-label mbr-fonts-style display-7">Last Name (Admin)</label>
                        ...
                        <div class="col-md-4  form-group" data-for="name">
                            <label for="name-form1-4" class="form-control-label mbr-fonts-style display-7">Canteen Name</label>
                            <input type="text" name="canteen_name" data-form-field="Name" required="required" class="form-control display-7" id="name-form1-4"
                            value="<?php if(isset($_POST['signupbutton'])){echo htmlentities($_POST['last_name']);}?>">
                        </div>
                        ...
                        <div data-for="repassword" class="col-md-4  form-group">
                         ...
                         <div data-for="repassword" class="col-md-4  form-group">
                            <label for="password-form1-4" class="form-control-label mbr-fonts-style display-7" >Location</label>
                            <input name="location" class="form-control display-7">
                        </div>
